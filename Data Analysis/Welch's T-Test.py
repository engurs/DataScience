...
def compare_averages(filename):
    """
     Perform a t-test on 2 sets of baseball data (left handed and right handed ).
     """
    # read data into panda dataframe
    baseball_data = pandas.read_csv("baseball_data.csv")

    # split the data set into 2 data frames
    ...
    # produce desired output with %95 confidence
    if result[1] <= .05:
        return False, result
    else:
        return True, result
